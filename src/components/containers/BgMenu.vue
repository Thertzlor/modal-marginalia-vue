...
const props = defineProps<{bigImgSwitch:boolean,bw:number,cw:number,menVis:boolean}>();
...
<template>
  ...
  <input id="menucheck" v-model="middleCheck" @change="emit('vis',middleCheck)" type="checkbox">
